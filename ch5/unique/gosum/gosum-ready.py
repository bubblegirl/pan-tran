...
def corelist():
	corelist = open('Gambierdiscus-unique-list.txt', 'w')
#	for file in glob("*_core-curated.txt"):
        for file in glob("/shared/homes/125155/pant-transcriptomes/re-run-wo-digi/Feb18_all-AA-clust/OMCL/no-secondary-clust/cluster-analysis/unique/*_unique-curated.txt"):
