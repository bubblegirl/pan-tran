...
%TODO consolidate what the next 2 sentences are trying to say
Indication of regulation between the transcriptional and translational stages of protein synthesis comes from a number of observations. 
...
Further the number of unannotated genes in dinoflagellate transcriptomes is high %TODO insert other studies
...
However sequencing further genomes in bacteria reveled a large transitory subset of genetic content, with the conclusion that a single strain based reference would be inadequate for capturing a large proportion of the species' genetic diversity \cite{tettelin2005genome}. 
...
Since then the core- and pan-genome, or transcriptome, concept has been adopted for eukaryotes also, with the realisation that the transient genomic phenomena holds true when multiple strains of a species are sequenced \cite{jin2016maize,plissonneau2018pangenome,read2013pan,li2014novo,song2015agape}.  
Inter-strain generation of pan- or core-genomic reference datasets for bacteria or eukaryotes with 
