...
Interestingly, the abundance of dinoSL was quite low (table ~\ref{tbl:ClustTable}) compared to the abundance observed by Zhang et al. (2009). 
...
These were from different sequencing runs as well as collected from different geographic locations, but are phylogenetically closely related. %TODO link appendix holmesii paper
