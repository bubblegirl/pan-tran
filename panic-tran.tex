...
Further the number of genes in dinoflagellates that do not share any similarity with other recorded sequences is high (Table ~\ref{tbl:dinoannotTable}). 
...
\hline
\textit{Karenia brevis}&3&55-467 \%&\cite{ryan2014novo}\\
\hline
&&&\\
\hline
\end{tabular}
...
Hence a reference, or baseline, for future sequencing projects is desirable.
