...
GOSUM was run at both levels 1 and 2 of GO counts with the go-basic GO reference. 
...
\FloatBarrier
\begin{itemize}
\item \textbf{Tim} I think I'm going to need to take out anything that links to Bacterial or unknown LCA and then re-run GOSUM. Thought?
