...
\item find conserved sequences of each KS cluster (yay for hmmer) and align clusters, run BI phylogeny to see if there is anything interesting there 
\end{itemize}

\subsection*{Last common ancestor determination of contigs}
Predicted proteins of each transcriptome were searched against the SwissProt and uniprot\_trEMBL databases \cite{uniprot2010ongoing}. 
...
\textbf{To do:}
\begin{itemize}
\item insert Venn diagram of of cluster overlap between the five species
\item describe differences in graphs once I know what needs to be taken out and re-run
\item GOSUM lvl2 graphs are partially missing descriptions on x-axis. Fix when re-run
\end{itemize}
...
- core and unique pretty evenly matched in most entries for gosum2 molec, except catalytic activity binding on DNA is  muchhigher in unique and a little higher for binding RNA
...
THIS IS WITH SWISSPROT ONLY, 20\% similarity and only 100bp overlap. trEMBL still running
\FloatBarrier
\begin{table}
...
\hline
\textbf{BASTA positive ID}&60,811&35263&&&\\ % -m 1
\hline
\textbf{Eukaryotic origin}&10,720&35,263&22,643&32,098&24,096\\
\hline
\textbf{Bacterial origin}&826&2,784&1,799&2,438&1,943\\
\hline
...
\textbf{To do:}
\begin{itemize}
\item insert Venn diagram of KS domains
