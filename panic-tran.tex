...
The transcriptome assemblies were queried for the active ketosynthase (KS) domain of the polyketide synthase (PKS) enzyme using hmmer \cite{eddy2015hmmer} with libraries developed for this project. 
